...
def api_bulk_upload_catalog():
    ...
    try:
        ...
        for row in csv_input:
            ...
            # Extract Logistics/Rules & New Detailed Fields
            ...
            try:
                ...
                # 3. Upsert Variant Details (If this row is a variant)
                if var_name and var_sku:
                    ...
                    if var_image_url:
                        # Grab the newly created or existing variant ID via stored proc
                        ...
                        if v_res:
                            ...
                            # Check if media already exists for this specific variant via stored proc
